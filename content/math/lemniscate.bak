...
<iframe src="https://www.desmos.com/3d/exq3evlctu?lang=en" width="1200" height="1000" allowfullscreen frameBorder="0" scrolling="no"></iframe>
...
where \(a\) determines the size of the curve. As \(\theta\) varies, the equation traces the two symmetric loops that form the characteristic figure-eight shape.
