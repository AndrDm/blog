...
IMUL r64, r64: Latency 3, Throughput 1

```
Test | VAL  | IPC  | Instr. | Cycles | TSCnt. | ExecT. | Boost | Base | Frequency
 THR   1.01   0.99   1.01 G   1.02 G   1.00 G   0.28 s   x1.02   3.49   3.57 GHz
 LAT   3.00   0.33   1.02 G   3.07 G   2.99 G   0.86 s   x1.02   3.49   3.58 GHz
---------------------------------------------------------------------------------
```

ADD r64, r64 (unrolled Loop): Latency 1, Throughput 0,33

```
Test | VAL  | IPC  | Instr. | Cycles | TSCnt. | ExecT. | Boost | Base | Frequency
 THR   0.33   3.06   1.00 G   0.33 G   0.32 G   0.09 s   x1.02   3.49   3.56 GHz
 LAT   1.01   0.99   1.00 G   1.02 G   0.99 G   0.28 s   x1.02   3.49   3.58 GHz
---------------------------------------------------------------------------------
```

ADD r64, r64 (tight Loop): Latency 1, Throughput 0,25

```
Test | VAL  | IPC  | Instr. | Cycles | TSCnt. | ExecT. | Boost | Base | Frequency
 THR   0.26   3.87   4.00 G   1.03 G   0.98 G   0.28 s   x1.05   3.49   3.67 GHz
