Привет, хабр! Под катом мы посетим китайский завод, где делают двигатели, заглянем внутрь ПЛК да попрограммируем его на разных языках, включая Си и C++, вплоть до ассемблера. Может быть любопытно для тех, кто интересуется промышленной автоматизацией.

Это будет пятничный "лонгрид", но разбивать его на несколько постов я не буду, чтобы не забивать вам ленту почём зря, поскольку материал специфический, довольно быстро уйдёт с главной в (не побоюсь этого слова) анналы хабра, и кто-нибудь будет время от времени находить его в поиске и таки найдёт для себя в этой простыне полезные "зёрна", пусть останется "всё в одном".
...
![](https://habrastorage.org/webt/ep/ly/io/eplyiosda5qfvqntoihej68o_pu.jpeg)
...
![](https://habrastorage.org/webt/pl/d9/ob/pld9obaqh3seppjhvwj7-5ozaw8.jpeg)
...
![](https://habrastorage.org/webt/hk/og/uf/hkogufjrqvaijnfj0bx4mnpr5ha.jpeg)
...
![](https://habrastorage.org/webt/6d/xl/oq/6dxloqpszpzf_anhyftdgtcbnme.jpeg)
...
![](https://habrastorage.org/webt/g8/np/wz/g8npwznmxqsze-lxzcozgwanefq.jpeg)
...
![](https://habrastorage.org/webt/lt/nk/vn/ltnkvn_0flgazvh-n4gk5qq86by.jpeg)
...
<spoiler title="чутка обсценной лексики под спойлером">

![](https://habrastorage.org/webt/tq/i-/zy/tqi-zyfys90we7-_t-vz43lwwh8.jpeg)
...
![](https://habrastorage.org/webt/gj/6e/e5/gj6ee5n8vls1agqxtxcnxurbqsc.jpeg)
...
![](https://habrastorage.org/webt/zi/hz/my/zihzmyrgftnvnkvtoalqf2jz1um.jpeg)

Впрочем нет, я могу "снять" крышку вот так, у меня ж есть томограф в цеху:

![](https://habrastorage.org/webt/iy/do/hw/iydohwvo_ntspfueztz98gqszig.jpeg)

Да и радиатор могу "скинуть", вот он, камушек и все потрошки контроллера:

![](https://habrastorage.org/webt/-s/in/ey/-sineyphoxrzzrmaclb0hc_1iga.jpeg)
...
![](https://habrastorage.org/webt/xa/u2/0y/xau20yg9tyjswh-fxrpkwlqgdyo.jpeg)
...
![](https://habrastorage.org/webt/gb/cl/di/gbcldiydcfa3nxgzgdsbpgodcci.jpeg)
...
![](https://habrastorage.org/webt/cq/nz/nx/cqnznxh6kwfacwsnafowjhbzqfu.jpeg)
...
![](https://habrastorage.org/webt/it/h9/yd/ith9ydei7x25afyja4vllj-xqv8.jpeg)
...
![](https://habrastorage.org/webt/vv/vl/co/vvvlcoctnugyntu8ib44yyazeiu.jpeg)

А вот начинка модуля выходов DO 9322:

![](https://habrastorage.org/webt/a1/9-/am/a19-ampbcar_32o_er7983xpnmy.jpeg)
...
![](https://habrastorage.org/webt/tt/8c/sd/tt8csdzbqz0syw_tpblg8cwee8w.jpeg)
...
![](https://habrastorage.org/webt/7e/37/pr/7e37pr5vxkyer98jtssskrzbtea.png)
...
![](https://habrastorage.org/webt/uy/g4/1a/uyg41admio-cxwii5bfkbg2id7u.gif)
...
![](https://habrastorage.org/webt/vx/oj/k3/vxojk36te9qc0eprnu7nl7jfowq.gif)
...
![](https://habrastorage.org/webt/rt/ug/gm/rtuggmfinighicbzcng4qna2jiy.png)
...
![](https://habrastorage.org/webt/fn/0y/ip/fn0yipcjahjrqz-sy6zq4id6xy8.gif)
...
![](https://habrastorage.org/webt/s-/xf/xf/s-xfxfw4ll7qkpdb2aqba6jrgro.png)
...
![](https://habrastorage.org/webt/mk/f9/3h/mkf93hr2wpw0nwnuwlfnfb1jf3u.png)
...
![](https://habrastorage.org/webt/mh/os/90/mhos90aewbqnccidkwxbieinftq.png)
...
![](https://habrastorage.org/webt/km/ps/9n/kmps9ny1abqeegnjfedrtaetvhm.png)
...
![](https://habrastorage.org/webt/sd/wl/b6/sdwlb61t6ypdmnmq08-7iony8ug.png)

Если у вас нет физического контроллера, то можно активировать симуляцию:

![](https://habrastorage.org/webt/d-/_-/3u/d-_-3u9ycab52rhfydnv6x0trr8.png)

IP адрес контроллера, к которому коннектимся, задаётся в Online->Settings:

![](https://habrastorage.org/webt/-8/ll/6i/-8ll6itcxajy1obgtzwqlyttopm.png)

Процесс загрузки выглядит вот так:

![](https://habrastorage.org/webt/xm/ct/dv/xmctdvu4s2_bhxfd-lw6m5ek1ti.gif)
...
![](https://habrastorage.org/webt/ks/2n/o-/ks2no-nrznxapzqo4e9bvt93uh8.gif)
...
![](https://habrastorage.org/webt/m-/vh/fj/m-vhfjrbu4z8wqlfwszc5pflanw.gif)
...
![](https://habrastorage.org/webt/u8/mh/so/u8mhsoo_e89xjocxk3iw2yqrxt0.gif)
...
![](https://habrastorage.org/webt/or/n9/vq/orn9vqf2f-dfsub8mbzfkarcto8.png)
...
![](https://habrastorage.org/webt/go/fu/vx/gofuvxv1i56seamgfytp-yqyt4s.png)
...
![](https://habrastorage.org/webt/xy/jg/a4/xyjga4ntgpaeynwxdewmdhuzq3c.png)
...
![](https://habrastorage.org/webt/kn/mk/-6/knmk-64exry-gktrmyzrr_tq5aa.png)
...
![](https://habrastorage.org/webt/j6/8v/1u/j68v1uxez-bpygsdoavp_-ewvyq.png)
...
![](https://habrastorage.org/webt/ee/0x/l9/ee0xl9ls3jjkkv0lzuockhw7a9e.png)

Это всё. У любого АСУ ТП инженера в ящике с инструментарием валяется OPC UA клиент, обычно пользуются UA Expert:

![](https://habrastorage.org/webt/o6/zc/hw/o6zchwf0r5barbgqn7uu5qcbur0.png)

Теперь мне проще всего взять LabVIEW с OPC UA тулкитом и набросать вот такую оснастку:

![](https://habrastorage.org/webt/6c/_v/ht/6c_vhtobsdogsbtbe9eenktafw4.png)

И вот мой график количества циклов:

![](https://habrastorage.org/webt/if/wg/fo/ifwgfo5drpwfghpof9erqcm_d5u.png)
...
![](https://habrastorage.org/webt/pl/jj/q1/pljjq1_jns_cb3kgwndv_rmnna4.png)
...
![](https://habrastorage.org/webt/xn/y3/ek/xny3ekwvb0n_8hhffxlo1zqerxq.png)
...
![](https://habrastorage.org/webt/m7/ts/nn/m7tsnnqsj6pabycbpdl6nuytrnm.png)
...
![](https://habrastorage.org/webt/s8/0d/xc/s80dxcysnxrjtbpsyblyssmfgpc.png)

А в логгере можно увидеть причину останова:

![](https://habrastorage.org/webt/jx/3r/4p/jx3r4pnud0hffkddzwpcsbp2bla.png)
...
![](https://habrastorage.org/webt/im/ws/no/imwsnospeznit5andh1dqizoc80.png)
...
![](https://habrastorage.org/webt/q9/pd/5o/q9pd5ocsblrubds2xlazr_qoouk.png)
...
![](https://habrastorage.org/webt/hi/aq/yh/hiaqyht8usw4n2jwchwd0mbwio8.jpeg)
...
![](https://habrastorage.org/webt/7r/ad/mc/7radmclhxudmkvy-77oqar05e5c.jpeg)

Ах да, я же обещал безопасные модули, вот они, занимают два слота:

![](https://habrastorage.org/webt/tt/hb/b2/tthbb29ch6qmt6x3y0oys4xdbyg.jpeg)
...
![](https://habrastorage.org/webt/wf/vt/un/wfvtuntjt4_zkgpkttyhn71grm0.png)
...
Наш ведущий инженер сделал универсальную библиотечку для конечных автоматов используя ООП, но во время проектирования он испытывал сильные моральные страдания, будучи вынужден пользоваться устаревшим инструментарием (пытаться подменять тулчейн смысла нет, там gcc допиленный B&R). Выкладывать код с работы я по понятным причинам не имею права (да и с выпуском AS6 он перешёл в состояние "легаси"), но на С++ существуют готовые открытые реализации конечных автоматов разной степени удобства и элегантности. Я взял одно из них — [High-Performance Hierarchical Finite State Machine](https://github.com/andrew-gresyk/HFSM2), авторства Andrew Gresyk (я не знаю, как правильно пишется фамилия моего тёзки по-русски). Эта реализация довольно удобная и свежая, в одном заголовочном файле, и полностью совместима с последней версией AS (что удивительно, там в [machine.hpp](https://github.com/andrew-gresyk/HFSM2/blob/master/include/hfsm2/machine.hpp) больше семнадцати тысяч строк, но нет, ни одной ошибки или даже предупреждения не вывалилось), кроме того снабжена готовым [примером светофора](https://github.com/andrew-gresyk/HFSM2/blob/master/examples/basic_traffic_light/main.cpp), который мы просто перетащим в проект AS. Ещё одна реализация есть вот здесь — [State Machine Design in C++](https://www.codeproject.com/Articles/1087619/State-Machine-Design-in-Cplusplus), но её не так удобно перекладывать на ПЛК.
...
![](https://habrastorage.org/webt/if/4m/lq/if4mlq5mjyrlc_6i7cnvby85kbk.gif)
...
![](https://habrastorage.org/webt/hs/xz/o6/hsxzo6fvuix3e8mqayelwktpkia.png)
...
![](https://habrastorage.org/webt/tm/gi/kl/tmgiklts3y5_kdwa6t4c8ik-hx8.png)

В остальном всё также, переменные маппятся на узлы OPC UA, и вот наша нехитрая программка на LabVIEW

![](https://habrastorage.org/webt/fl/ky/ir/flkyirpul3t5bbyi8rueun5s8aa.png)

бодро мигает светофором из ПЛК:

![](https://habrastorage.org/webt/3z/ly/cc/3zlyccc-dckgs3dss6i--48jhuu.gif)
...
![](https://habrastorage.org/webt/c5/kx/1e/c5kx1ebocquxk5pwty7orh8hzze.png)

Там много чего можно сделать, например бросить на панель видеоплеер и развлекать оператора видосиками:

![](https://habrastorage.org/webt/uu/-d/al/uu-dalnkpzzrxtzbhfvg1eouhb8.png)
...
![](https://habrastorage.org/webt/k3/cg/jt/k3cgjtnlxli6l5mkcbyiyntf7sa.png)
...
![](https://habrastorage.org/webt/k0/45/vj/k045vjckyufwhyljfdnaatnrrmg.gif)
...
![](https://habrastorage.org/webt/ip/kh/3s/ipkh3so3xwjjw0nqxdlkxkzlp7w.jpeg)
...
<spoiler title="Опции командной строки">
