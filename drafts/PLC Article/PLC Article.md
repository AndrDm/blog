...
Почему я взял именно этот завод для примера? А потому, что ваш покорный слуга принимал самое непосредственно участие в разработке этой системы (что на самом первом фото), правда писал я там часть машинного зрения для дефектоскопии, чуть более чем полностью. Системе, что на фото — около двадцати лет от роду.
...
Да и радиатор могу "скинуть", вот он, камушек и все его потрошки:
...
Для обучения юных падаванов наши практиканты собрали такой вот кубик, тут нет ничего особенного — собствнно GKR, точно такой же как в обзоре, но с пристёгнутой безопасной частью, пара сервомоторов на SafeMotion, стандартный B&R монитор для SCADA/HMI, кнопки да индикаторы, больше в общем ничего и не надо:

![](assets/stand_photo_2024-12-19_17-37-08.jpg)

Ниже в разделе "Безопасность" будет фотка "безопасных" модулей..
