...
Я не буду превращать пост в простыню скриншотов, коих и так будет много (у меня в общем не стоит задачи заменить инструкцию), просто обозначу ключевые места, чтобы у вас сложилась "общая картина" того, как с этой штукой работают. У меня, кстати, остались кой какие учебные материалы, в том числе на русском, если кому надо — стукнитесь в личку. Добрый китайский товарищ выложил часть на [Гитхаб-brtraining](https://github.com/brtraining/brtraining.github.io/tree/master/TM42ENG), там правда какая-то часть на китайском, если кому надо.
...
Вам доступно восемь "Cyclic" слотов с разным временем цикла. Неиспользуемые слоты можно удалить. Программы можно добавлять сюда и перетаскивать их между слотами мышкой. В один слот можно поместить любое количество программ (предел мне неизвестен). Есть приоритеты — чем выше программа в слоте, тем выше её приоритет. Предопределённое время каждого слота можно изменить вот здесь:
